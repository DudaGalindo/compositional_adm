...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas = np.load('flying/results_water_inj_6k_200_FOU_modified_case_2113.npy', allow_pickle=True)
        ...
        plt.plot(x1, So, 'k', x_CMG, So_CMG, 'r')
        ...
        plt.figure(3)
        plt.title('t = 200 days')
        plt.plot(x1, Sw, 'k', x_CMG, Sw_CMG, 'r')
        plt.legend(('PADMEC-FOUM', 'CMG', 'PADMEC-MUSCL'))
