...
xD = np.loadtxt('x_BL_FR_analytical.txt')
SwD = np.loadtxt('Sw_BL_FR_analytical.txt')
f = interp1d(xD,SwD)
    ...
    if  arq.startswith(name):
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x8[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x8 = x8.flatten()
            x8_avg = np.linspace(0+1/(2*n),1-1/(2*n),n)
            #x8 = np.linspace(xD[-1],1,n)
            e8_L1_FR2 = (sum(abs(f(x8)-Sw8))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x16[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x16 = x16.flatten()
            x16_avg = np.linspace(0+1/(2*n),1-1/(2*n),n)

            e16_L1_FR2 = (sum(abs(f(x16)-Sw16))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x32[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x32 = x32.flatten()
            x32_avg = np.linspace(0+1/(2*n),1-1/(2*n),n)
            #x32= np.linspace(xD[-1],1,n)
            e32_L1_FR2 = (sum(abs(f(x32)-Sw32))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x64[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x64 = x64.flatten()
            x64_avg = np.linspace(0+1/(2*n),1-1/(2*n),n)

            e64_L1_FR2 = (sum(abs(f(x64)-Sw64))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x128[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x128 = x128.flatten()
            #x128 = np.linspace(xD[-1],1,n)
            x128_avg = np.linspace(0+1/(2*n),1-1/(2*n),n)
            e128_L1_FR2 = (sum(abs(f(x128)-Sw128))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x256[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x256 = x256.flatten()
            #x256 = np.linspace(xD[-1],1,n)
            x256_avg = np.linspace(0+1/(2*n),1-1/(2*n),n)
            e256_L1_FR2 = (sum(abs(f(x256)-Sw256))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x512[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x512 = x512.flatten()
            #x512 = np.linspace(xD[-1],1,n)
            x512_avg = np.linspace(0+1/(2*n),1-1/(2*n),n)
            e512_L1_FR2 = (sum(abs(f(x512)-Sw512))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x8_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x8_FR3 = x8_FR3.flatten()
            #x8 = np.linspace(xD[-1],1,n)
            e8_L1_FR3 = (sum(abs(f(x8_FR3)-Sw8_FR3))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x16_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x16_FR3 = x16_FR3.flatten()

            e16_L1_FR3 = (sum(abs(f(x16_FR3)-Sw16_FR3))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x32_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x32_FR3 = x32_FR3.flatten()

            e32_L1_FR3 = (sum(abs(f(x32_FR3)-Sw32_FR3))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x64_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x64_FR3 = x64_FR3.flatten()

            e64_L1_FR3 = (sum(abs(f(x64_FR3)-Sw64_FR3))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x128_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x128_FR3 = x128_FR3.flatten()

            e128_L1_FR3 = (sum(abs(f(x128_FR3)-Sw128_FR3))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x256_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x256_FR3 = x256_FR3.flatten()

            e256_L1_FR3 = (sum(abs(f(x256_FR3)-Sw256_FR3))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x512_FR3[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x512_FR3 = x512_FR3.flatten()

            e512_L1_FR3 = (sum(abs(f(x512_FR3)-Sw512_FR3))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x8_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x8_FR4 = x8_FR4.flatten()
            #x8 = np.linspace(xD[-1],1,n)
            e8_L1_FR4 = (sum(abs(f(x8_FR4)-Sw8_FR4))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x16_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x16_FR4 = x16_FR4.flatten()
            e16_L1_FR4 = (sum(abs(f(x16_FR4)-Sw16_FR4))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x32_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x32_FR4 = x32_FR4.flatten()
            e32_L1_FR4 = (sum(abs(f(x32_FR4)-Sw32_FR4))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x64_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x64_FR4 = x64_FR4.flatten()
            e64_L1_FR4 = (sum(abs(f(x64_FR4)-Sw64_FR4))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x128_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x128_FR4 = x128_FR4.flatten()
            e128_L1_FR4 = (sum(abs(f(x128_FR4)-Sw128_FR4))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x256_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x256_FR4 = x256_FR4.flatten()
            e256_L1_FR4 = (sum(abs(f(x256_FR4)-Sw256_FR4))*(300 / n))
        ...
        for data in datas[datas.shape[0]-1:]:
            ...
            for i in range(len(points)):
                x512_FR4[:,i] = np.linspace(xD[-1]+(points[i] + 1)*1/(2*n),1-(1-points[i])*1/(2*n),n)
            x512_FR4 = x512_FR4.flatten()
            e512_L1_FR4 = (sum(abs(f(x512_FR4)-Sw512_FR4))*(300 / n))
        ...
        plt.savefig('results/compositional/FR/saturation_BL_Bastian_FR2_meshes.png')
        ...
        plt.ylabel('Water Saturation')
        plt.xlabel('Dimensionless distance')
        plt.savefig('results/compositional/FR/saturation_BL_Bastian_FR3_meshes.png')
        ...
        plt.ylabel('Water Saturation')
        plt.xlabel('Dimensionless distance')
        plt.savefig('results/compositional/FR/saturation_BL_Bastian_FR4_meshes.png')
        ...
        plt.savefig('results/compositional/FR/saturation_BL_Bastian_FR2_converg.png')
        ...
        plt.ylabel('log$_{10}(E_{L_1})$')
        plt.xlabel('$log_{10}(N)$')
        plt.savefig('results/compositional/FR/saturation_BL_Bastian_FR3_converg.png')
        ...
        plt.ylabel('log$_{10}(E_{L_1})$')
        plt.xlabel('$log_{10}(N)$')
        plt.savefig('results/compositional/FR/saturation_BL_Bastian_FR4_converg.png')

        plt.figure(7)
        plt.plot(x,y,'-bo',x,y3,'-rP', x, y4, '-gv')
        plt.plot(x,-x+1,'k')
        plt.grid()
        plt.legend(('FR-2nd order', 'FR-3rd order', 'FR-4th order', 'Reference Line'))
        plt.title('Buckley-Leverett Solution Example Bastian - FR convergence')
        plt.ylabel('log$_{10}(E_{L_1})$')
        plt.xlabel('$log_{10}(N)$')
        plt.savefig('results/compositional/FR/saturation_BL_Bastian_FR_converg.png')
        ...
        plt.ylabel('Water Saturation')
        plt.xlabel('Dimensionless distance')
        plt.savefig('results/compositional/FR/saturation_BL_Bastian_32_comparison.png')
        ...
        plt.ylabel('Water Saturation')
        plt.xlabel('Dimensionless distance')
        plt.savefig('results/compositional/FR/saturation_BL_Bastian_32_comparison_zoom.png')
        ...
        plt.ylabel('Water Saturation')
        plt.xlabel('Dimensionless distance')
        plt.savefig('results/compositional/FR/saturation_BL_Darlan_64_comparison.png')
        ...
        plt.ylabel('Water Saturation')
        plt.xlabel('Dimensionless distance')
        plt.savefig('results/compositional/FR/saturation_BL_Darlan_256_comparison.png')
        ...
        plt.ylabel('Water Saturation')
        plt.xlabel('Dimensionless distance')
        plt.savefig('results/compositional/FR/saturation_BL_Darlan_512_comparison.png')
        ...
        plt.ylabel('Water Saturation')
        plt.xlabel('Dimensionless distance')
        plt.savefig('results/compositional/FR/saturation_BL_Darlan_8_comparison.png')
        ...
        plt.ylabel('Water Saturation')
        plt.xlabel('Dimensionless distance')
        plt.savefig('results/compositional/FR/saturation_BL_Darlan_16_comparison.png')
