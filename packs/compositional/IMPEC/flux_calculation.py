...
class FR:
    ...
    def run(self, M, fprop, wells, Ft_internal_faces, Nk_SP_old, P_old, q, delta_t):
        ...
        Nk_SP = self.MLP_slope_limiter(np.copy(Nk_SP))
    ...
    def MLP_slope_limiter(self, Nk_SP_in):
        ...
        #Phi_P1[abs(Nk_P1_vertex - Nk_P0_vertex) > 0] = Phi_r[abs(Nk_P1_vertex - Nk_P0_vertex) > 0]
        Phi_P1 = np.min(Phi_r,axis=2)
