...
for arq in arquivos:
    if  arq.startswith(name):
        ...
        datas = np.load('flying/results_water_inj_6k_16_modified_case_1048.npy', allow_pickle=True)
        for data in datas[2:]:
            Sw = data[5]
            So = data[6]
            Sg = data[7]
        ...
        datas = np.load('flying/results_water_inj_6k_16_MUSCL_modified_case_upw_715.npy', allow_pickle=True)
        for data in datas[2:]:
            Sw_MUSCL = data[5]
            So_MUSCL = data[6]
            Sg_MUSCL = data[7]
        ...
        plt.xlabel('Distance')
        plt.legend(('PADMEC-LLF', 'PADMEC-FOUM', 'CMG', 'PADMEC-MUSCL'))
        plt.grid()
        ...
        datas = np.load('flying/results_water_inj_6k_8_MUSCL_modified_case_LLF_573.npy', allow_pickle=True)
        for data in datas[2:]:
            Sw_MUSCL8 = data[5]
            So_MUSCL8 = data[6]
            Sg_MUSCL8 = data[7]
        ...
        datas = np.load('flying/results_water_inj_6k_32_MUSCL_modified_case_LLF_1144.npy', allow_pickle=True)
        for data in datas[2:]:
            Sw_MUSCL32 = data[5]
            So_MUSCL32 = data[6]
            Sg_MUSCL32 = data[7]
        ...
        datas = np.load('flying/results_water_inj_6k_64_MUSCL_modified_case_LLF_1495.npy', allow_pickle=True)
        for data in datas[2:]:
            Sw_MUSCL64 = data[5]
            So_MUSCL64 = data[6]
            Sg_MUSCL64 = data[7]
